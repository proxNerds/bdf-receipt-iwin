...
<div class="container">
    <div class="row mt-4 mb-4">
        <div class="col text-center">
            <h3 class="text-uppercase">L'iniziativa inizierà il {{ Carbon\Carbon::parse(env('CONTEST_START_DATE'))->format('d/m/Y') }} alle ore {{ Carbon\Carbon::parse(env('CONTEST_START_DATE'))->format('H:i:s') }}</h3>
        </div>
    </div>
